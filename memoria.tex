...
\\La comparación de ambas métricas permite observar que proyectos se encuentran obsoletos en la actualidad, debido a que no hayan sufrido modificaciones en un período largo de tiempo, así como también que proyectos tienen una tendencia constante con la finalidad de mantener el proyecto
actualizado.
