...
A continuación, tras recopilar y procesar los datos, así como aplicar la metodología correspondiente, se interpretan los resultados obtenidos del análisis graficamente. Estas gráficas
...
La figura ~\ref{fig:grafica-commits} muestra graficamente la evolución del número de commits en cada uno de los repositorios seleccionados a lo largo de los años. Se observa una etapa de
desarrollo desde el año 2008 hasta la actualidad, siendo del año 2016 hasta el año 2024 el período de mayor actividad.
\\Como se puede observar, el repositorio \textit{notebook} se corresponde con el proyecto más longevo, ya que comenzó a desarrollarse en el año 2008 y sigue vigente en la actualidad.
Se identifica con un desarrollo constante pero con períodos de baja actividad, no ha sufrido su mayor etapa de desarrollo hasta el año 2019, donde tiene varios períodos intensos de actividad,
siendo el año 2023 el más destacable.
Por otra parte, el repositorio \textit{code-edit} se corresponde con el proyecto más nuevo, compartiendo su mayor período de actividad con el año de su creación, que se corresponde con el año 2022.
\\Se observan repositorios de corta duración, que hoy en día se encuentran en desuso y que no han tenido gran éxito dentro del mundo del software libre, como lo son \textit{nba-go} y \textit{ublhub}.
En el lado opuesto, se encuentran los repositorios de larga trayectoria y que tienen un ritmo de actividad alto con una gran frecuencia de cambios a lo largo de los años, destacamos \textit{luxon}, 
\textit{core}, \textit{notebook} y \textit{Rath}. Estos proyectos, debido a estar actualizados de manera constante, estiman menos costes en términos de esfuerzo para implementar  nuevas funcionalidades
o mantenimientos.
...
La figura ~\ref{fig:grafica-colaboradores} se corresponde con la cantidad de colaboradores de un proyecto a lo largo de los años. Se observan proyectos con un bajo número de colaboradores
a lo largo de su desarrollo, lo que se traduce en un bajo atractivo del proyecto dentro de la comunidad de software libre, entre los que destacamos \textit{ublhub}, \textit{Kap} y \textit{nba-go}.
\\Por otro lado, se observan proyectos con gran número de colaboradores en un inicio pero que han ido disminuyendo a lo largo de los años, esto indica un decrecimiento del propio proyecto
...
\\\textit{Notebook} y \textit{Rath} se corresponden con proyectos que han sufrido un pico en su desarrollo en el año 2022, siendo el año donde han alcanzado su número máximo de colaboradores,
pero no han conseguido mantener esta tendencia, y en los próximos años su número de colaboradores vuelve a disminuir volviendo a situarse como en periodos anteriores.
\\\textit{Core} es el repositorio que sufre mayores picos de crecimiento de colaboradores a lo largo de su desarrollo, por lo que resulta ser el proyecto más atractivo dentro de la comunidad 
de software libre, llegando a contar hasta con 350 colaboradores.
