...
a lo largo de los años en comparación con las líneas que han sido eliminadas. Dicho de otra manera, se estudia la evolución de las líneas vivas en relación a las líneas muertas en un período de tiempo.

\\Por un lado, la gráfica ~\ref{fig:líneas-muertas} estudia la cantidad de líneas que han sido eliminadas a lo largo de los años, mientras que la figura~\ref{fig:líneas-vivas} muestra el porcentaje de
...
\\Como se puede observar, el repositorio de \textit{nba-go} en ningún momento ha eliminado líneas de código, por lo que practicamente el 100\% del código de programación se mantiene constante desde su
primera creación, siendo un proyecto que se ha quedado desactualizado y en desuso desde el año 2019. Otro repositorio a destacar el denominado \textit{Kap}, donde se observa que unicamente se
