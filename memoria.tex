...
En este caso, se ha realizado un análisis estadístico individual para cada repositorio, determinando el porcentaje de presencia de cada lenguaje de programación utilizado en cada uno de ellos.
Se han generado 11 gráficas distintas como resultado, pero se enfocará la atención en las más relevantes.
\\En la figura~\ref{fig:lenguajes-perceval} se identifican 14 lenguajes de programación distintos para el repositorio \textit{grimoirelab-perceval}. De entre toda la variedad de lenguajes utilizados,
JSON, Markdown y Python son los que tienen mayor representación, componen en torno al 70\% del código, siendo JSON el de mayor presencia de los tres con un 34\%.
\\Cuando se analiza el repositorio de \textit{notebook} se encuentran aún más lenguajes de programación, llegando a ser un número de 19 como se puede observar en la figura~\ref{fig:lenguajes-notebook}.
El lenguaje de programación JSON sigue siendo el imponente frente al resto, seguido de TypeScript. Con menor presencia que estos pero aún con protagonismo, también se encuentran los lenguajes de CSS+Lasso,
Django, Markdown y YAML, que forman en torno al 12\% del código de programación.
\\Por último, se interpreta en la figura~\ref{fig:lenguajes-rath} los lenguajes de programación utilizados en el repositorio \textit{rath}. En este caso, de entre los 15 lenguajes utilizados, Python y 
JavaScript son los predominantes con 27\% y un 3\% respectivamente. Otros lenguajes que tienen mucha presencia dentro del repositorio son JSON, Markdown y Python.
